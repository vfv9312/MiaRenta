        ...
        <div class="antialiased bg-gray-50 dark:bg-gray-900">
            ...
            <aside
                ...
                <div class="h-full px-3 py-5 overflow-y-auto bg-white dark:bg-gray-800">
                    ...
                    <ul class="space-y-2">
                        ...
                        <li>
                            ...
                            <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                                ...
                                <li>
                                    <a href="#"
                                        class="flex items-center w-full p-2 text-base font-medium text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Productos
                                        en Renta</a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul id="dropdown-ordenes" class="hidden py-2 space-y-2">
                                ...
                                <li>
                                    <a href="#"
                                        class="flex items-center w-full p-2 text-base font-medium text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Ordenes
                                        Procesadas</a>
                                </li>
                    ...
                    <ul class="pt-5 mt-5 space-y-2 -t -gray-200 dark:-gray-700">
                        <li>
                            <a href="#"
