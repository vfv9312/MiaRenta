                ...
                @forelse ($alquileres as $alq)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700">
                            ...
                            Ent: {{ $alq->fecha_entrega ? $alq->fecha_entrega->format('d/m/Y H:i') : 'N/A' }}<br>
                            Rec: {{ $alq->fecha_recepcion ? $alq->fecha_recepcion->format('d/m/Y H:i') : 'N/A' }}
                        </td>
                        ...
                        <td class="px-4 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                            ...
                            <a href="https://wa.me/{{ preg_replace('/\D/', '', $alq->cliente->telefonos->first()->telefono ?? '') }}?text=Hola,%20adjunto%20el%20ticket%20de%20su%20renta%20%23{{ $alq->id }}.%20Puede%20consultarlo%20aquí:%20{{ route('ticket', $alq->id) }}" target="_blank" class="text-green-500 hover:text-green-700" title="WhatsApp">
