...
<footer class="m-4 bg-white rounded-lg shadow-sm dark:bg-gray-800">
    <div class="w-full max-w-screen-xl p-4 mx-auto md:flex md:items-center md:justify-between">
      <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="{{ route('home')}}" class="hover:underline">MÍA RENTA</a>. Todos los derechos reservados.
    </span>
